...
function Community() {
  ...
  const handleCreatePost = (e) => {
    ...
    const authorAvatar = user.role === "driver" ? "🚑" : user.role === "hospital" ? "🏥" : user.role === "admin" ? "🛡️" : "👤";
      ...
      <header className="border-b border-gray-800 bg-[#161a23]/60 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <Link to={getDashboardPath()} className="flex items-center gap-3 hover:opacity-95 transition">
      ...
      <section className="bg-[#161a23]/30 border-b border-gray-900 sticky top-[73px] z-40 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 flex justify-start gap-6">
          <button
            ...
            className={`py-4 px-2 text-sm font-bold tracking-wide transition border-b-2 flex items-center gap-2 uppercase ${
              activeTab === "feed"
        ...
        {activeTab === "feed" ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* Write Post Card */}
              <div className="bg-[#161a23]/90 border border-gray-800 p-6 rounded-3xl shadow-xl shadow-black/30 backdrop-blur-lg">
                ...
                <form onSubmit={handleCreatePost} className="space-y-4">
                  <textarea
                    ...
                    className="w-full bg-[#1e2330] border border-gray-800 text-white rounded-2xl p-4 text-sm focus:outline-none focus:border-red-500 transition placeholder-gray-600 resize-none"
                  ></textarea>
                  ...
                  {postImageBase64 && (
                    <div className="relative inline-block mt-2">
                      ...
                      <button
                        ...
                        className="absolute -top-2 -right-2 bg-red-600 hover:bg-red-500 text-white p-1.5 rounded-full shadow-md transition"
                      >
                  ...
                  <div className="flex justify-between items-center pt-2 border-t border-gray-800">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 text-xs font-bold text-gray-400 hover:text-red-400 transition"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white font-semibold rounded-xl text-xs transition duration-200 shadow-md shadow-red-900/20 disabled:opacity-40 disabled:cursor-not-allowed uppercase tracking-wider"
                    >
                ...
                {posts.map((post) => {
                  ...
                  return (
                    <div key={post.id} className="bg-[#161a23] border border-gray-800 p-6 rounded-3xl shadow-xl space-y-4">
                      ...
                      {/* Attached Image (Mock file upload preview) */}
                      {post.image && (
                      ...
                      <div className="flex gap-6 items-center pt-3 border-t border-gray-800/60">
                        ...
                        <button
                          ...
                          className="flex items-center gap-2 text-xs font-bold text-gray-500 hover:text-red-400 transition"
                        >
                        ...
                        <div className="pt-4 border-t border-gray-800/40 space-y-4 animate-fadeIn">
                          ...
                          <div className="flex gap-2">
                            <input
                              ...
                              className="flex-grow bg-[#1e2330] border border-gray-800 text-white rounded-xl px-4 py-2 text-xs focus:outline-none focus:border-red-500 transition placeholder-gray-600"
                            />
                            <button
                              onClick={() => handleSubmitComment(post.id)}
                              className="px-3 bg-red-600 hover:bg-red-500 text-white font-bold rounded-xl transition flex items-center justify-center"
                            >
                              <FiSend className="w-3.5 h-3.5" />
                            </button>
                          </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-[#161a23] border border-gray-800 p-6 rounded-3xl shadow-xl space-y-6">
                <div className="border-b border-gray-800 pb-4">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Connect with trauma coordinators, dispatch crew, and hospital staff.</p>
                </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-[#161a23] border border-gray-800 p-6 rounded-3xl shadow-xl space-y-6">
                <div className="border-b border-gray-800 pb-4">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Found a blocked road or heavy pothole lane? Log it below to warn other dispatchers.</p>
                </div>
                ...
                <form onSubmit={handleCreateHazard} className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {["low", "medium", "critical"].map((sev) => (
                        <button
                          ...
                          className={`py-2 px-1 text-[10px] font-bold rounded-xl border transition capitalize ${
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      className="w-full bg-[#1e2330] border border-gray-800 text-white rounded-xl p-4 text-xs focus:outline-none focus:border-red-500 transition placeholder-gray-600 resize-none leading-relaxed"
                    ></textarea>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white font-bold rounded-xl text-xs transition duration-200 shadow-md shadow-red-950/20 uppercase tracking-wider"
                  >
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-[#161a23] border border-gray-800 p-6 rounded-3xl shadow-xl space-y-6">
                <div className="flex justify-between items-center border-b border-gray-800 pb-4">
                  <div>
                    <h2 className="text-white font-bold text-lg leading-tight">Active Hazards Board</h2>
                    <p className="text-xs text-gray-500 mt-0.5">Voted and reported by ambulance crews and dispatchers. **Highest upvoted bubble to the top**.</p>
                  </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-grow space-y-2">
                          ...
                          <p className="text-xs text-gray-400 leading-relaxed">{haz.description}</p>
